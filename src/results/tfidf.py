...
class TfIdf:
    ...
    def ret_df(self):
        self.df.to_csv('./data/raw_dataset_csv/mentioned.csv' ,index=False)
        return self.df
    ...
    def calculate(self, methodc):
            ...
            if (methodc == 1):
                ...
                wdict = self.compute_words_dict_per_global_cateogy()
                res = self.compute_global(wdict)
            return res

    def compute_global(self, wcount):
        total_n = {}
    ...
    def compute_words_dict_per_global_cateogy(self):
        ...
        ran_max = len(list(OtherCategory)) + 1
